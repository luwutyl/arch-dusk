...
//	|FlexWinBorders // use the SchemeFlex* color schemes, falls back to SchemeTitle* if disabled
	...
	|BarBorder // draw a border around the bar |BarBorderColBg // optionally use the bar background colour for the bar border (rather than border colour)
...
static char dmenunormbgcolor[] = "#1E2A36";

static char dmenuselfgcolor[]  = "#FFFFFF";
static char dmenuselbgcolor[]  = "#3478B5";

static char dmenubordercolor[] = "#4FA3E3";
...
//static char *colors[SchemeLast][4] = {
//	/*                       fg         bg         border    */
//	[SchemeNorm]         = { "#DCE7F2", "#1E2A36", "#1E2A36" },
//
//	[SchemeTitleNorm]    = { "#DCE7F2", "#1E2A36", "#2B3E52" },
//	/* Фокус окна — ярче и насыщеннее */
//	[SchemeTitleSel]     = { "#FFFFFF", "#3478B5", "#4FA3E3" },
//
//	[SchemeScratchNorm]  = { "#DCE7F2", "#1E2A36", "#2B3E52" },
//	[SchemeScratchSel]   = { "#FFFFFF", "#3478B5", "#4FA3E3" },
//
//	[SchemeHidNorm]      = { "#9FB6CC", "#1E2A36", "#000000" },
//	[SchemeHidSel]       = { "#EAF4FF", "#2F6FA6", "#4FA3E3" },
//
//	/* Срочное — без изменений, уже контрастно */
//	[SchemeUrg]          = { "#F2F2F2", "#8A2E2E", "#8A2E2E" },
//
//	/* Помеченные — слегка ярче */
//	[SchemeMarked]       = { "#D0E9FF", "#3A6FA0", "#3A6FA0" },
//
//	[SchemeWsNorm]       = { "#DCE7F2", "#1E2A36", "#000000" },
//	[SchemeWsVisible]    = { "#EAF4FF", "#2F6FA6", "#000000" },
//	/* Выбранный workspace — самый яркий */
//	[SchemeWsSel]        = { "#FFFFFF", "#3F8FD6", "#000000" },
//	[SchemeWsOcc]        = { "#B7D7E8", "#1E2A36", "#000000" },
//};
...
//static char *colors[SchemeLast][4] = {
//    /*                       fg         bg         border    */
//    [SchemeNorm]         = { "#6d8dad", "#1e222a", "#61afef" },
//    [SchemeTitleNorm]    = { "#1e222a", "#2e323a", "#2e323a" },
//    [SchemeTitleSel]     = { "#1e222a", "#61afef", "#61afef" },
//    [SchemeScratchNorm]  = { "#1e222a", "#6d8dad", "#6d8dad" },
//    [SchemeScratchSel]   = { "#1e222a", "#61afef", "#61afef" },
//    [SchemeHidNorm]      = { "#1e222a", "#545862", "#2e323a" },
//    [SchemeHidSel]       = { "#6d8dad", "#61afef", "#61afef" },
//    [SchemeUrg]          = { "#E0E0E0", "#A23419", "#A23419" },
//    [SchemeMarked]       = { "#1e222a", "#e06c75", "#6d8dad" },
//    [SchemeWsNorm]       = { "#6d8dad", "#1e222a", "#1e222a" },
//    [SchemeWsVisible]    = { "#545862", "#6d8dad", "#545862" },
//    [SchemeWsSel]        = { "#545862", "#61afef", "#545862" },
//    [SchemeWsOcc]        = { "#6d8dad", "#2e323a", "#1e222a" },
//};
...
//	[SchemeNorm]         = { "#DCE7F2", "#1E2A36", "#1E2A36" },
//	[SchemeTitleNorm]    = { "#DCE7F2", "#1E2A36", "#2B3E52" },
//	[SchemeTitleSel]     = { "#EAF2FA", "#2E5E8A", "#2E5E8A" },
//
//	[SchemeScratchNorm]  = { "#DCE7F2", "#1E2A36", "#2B3E52" },
//	[SchemeScratchSel]   = { "#EAF2FA", "#2E5E8A", "#2E5E8A" },
//
//	[SchemeHidNorm]      = { "#9FB6CC", "#1E2A36", "#000000" },
//	[SchemeHidSel]       = { "#DCE7F2", "#2E5E8A", "#000000" },
//
//	[SchemeUrg]          = { "#F2F2F2", "#8A2E2E", "#8A2E2E" }, // срочное — контраст
//
//	[SchemeMarked]       = { "#B7D7E8", "#3A5F7D", "#3A5F7D" },
//
//	[SchemeWsNorm]       = { "#DCE7F2", "#1E2A36", "#000000" },
//	[SchemeWsVisible]    = { "#EAF2FA", "#2E5E8A", "#000000" },
//	[SchemeWsSel]        = { "#EAF2FA", "#3F7FB3", "#000000" },
//	[SchemeWsOcc]        = { "#B7D7E8", "#1E2A36", "#000000" },
//};
...
static Rule clientrules[] = {
	 ...
	 */
//	{ .wintype = "_KDE_NET_WM_WINDOW_TYPE_OVERRIDE", .flags = AlwaysOnTop },
	...
	{ .instance = "spfm (r)", .scratchkey = 'r', .flags = Floating, .floatpos = "50% 50% 92% 90%" },
  { .instance = "Telegram", .scratchkey = 't', .flags = Floating|Centered, .floatpos = "50% 50% 45% 90%" },
  { .instance = "discord", .scratchkey = 'y', .flags = Floating|Centered, .floatpos = "50% 50% 92% 90%"},
...
static const char *spdiscord_y[] = {"y", "discord", NULL };

static Key keys[] = {
	/* type       modifier                      key              function                argument */
//  { KeyPress,   MODKEY,                       XK_y,            spawn,                  {.v = spdiscord_y} },
  { KeyPress,   MODKEY|Alt,                   XK_e,            spawn,                  {.v = spsteam } },
...
//  { KeyPress,   MODKEY,                       XK_t,            spawn,                  {.v = spcmd_t } },
  ...
  { KeyPress,   MODKEY,                       XK_Print,        spawn,                  SHCMD("sleep 0.5; flameshot gui")},
  { KeyPress,   MODKEY|Alt,                   XK_Print,        spawn,                  SHCMD("sleep 0.3; flameshot full") },
  ...
  { KeyPress, MODKEY|Alt,                   XK_c,            spawn,                CMD("clipmenu") },       //clipboard buffer dmenu
    ...
    { KeyPress, MODKEY|Ctrl,                  XK_g,            floatpos,             {.v = "50% 50% 80% 90%" } }, // center client and take up 80% of the screen
    { KeyPress, MODKEY|Alt|Ctrl,              XK_g,            floatpos,             {.v = "50% 50% 50% 50%" } },
    { KeyPress, MODKEY|Alt,                   XK_g,            floatpos,             {.v = "50% 50% 45% 90%" } },
    { KeyPress, MODKEY|Shift,                 XK_g,            floatpos,             {.v = "50% 50% 92% 90%"} },
...
//	STACKKEYS(AltGr|Shift,                                       stackswap)                            // swap the currently focused client with the nth client in the stack
  ...
  SCRATCHKEYS(MODKEY,                         XK_y,            spdiscord_y)
